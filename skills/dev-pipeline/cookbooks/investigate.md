...
**Next steps**:
- To write requirements: `/dev-pipeline prd {recommended approach}`
- To plan implementation: `/dev-pipeline plan {recommended approach}`
- For deeper codebase context: `/dev-pipeline research {specific component}`
