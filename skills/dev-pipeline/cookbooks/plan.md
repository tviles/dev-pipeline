...
Save to `.claude/dev-pipeline/plans/{slug}.plan.md` where `{slug}` is a kebab-case feature name.
...
**File**: `.claude/dev-pipeline/plans/{slug}.plan.md`
...
**Next Step**: `/dev-pipeline implement .claude/dev-pipeline/plans/{slug}.plan.md`
```
